"""
dice.py — Physical dice rolling system. Identical to Route 7.
Not used by The Honda Years (no dice checks), included for
...
def _announce_2d6(dice, total):
    ...
    if total == 12:
        ...
        print(f"  {C.RED}[{result_str}] = {total} — Rough.{C.RESET}")
