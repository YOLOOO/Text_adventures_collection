...
Identical contract to Hotel Midnight / ISS Dragonhold.
...
def dispatch_says(text):
    """DISPATCH — the Route 7 automated announcement system."""
    filled = textwrap.fill(text, width=WRAP_WIDTH - 2, subsequent_indent="  ")
    print(f"\n  {C.CYAN}{C.BOLD}📻 DISPATCH:{C.RESET}")
